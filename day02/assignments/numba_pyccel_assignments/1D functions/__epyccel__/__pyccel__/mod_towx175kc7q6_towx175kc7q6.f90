module mod_towx175kc7q6_towx175kc7q6
    ...
    do n = 0_i64, nt - 1_i64, 1_i64
      ...
      do i = 1_i64, nx - 1_i64 - 1_i64, 1_i64
        u(i) = un(i) - un(i) * dt / dx * (un(i) - un(i - 1_i64)) + nu * &
              ...
              - 1_i64))
        u(0_i64) = un(0_i64) - un(0_i64) * dt / dx * (un(0_i64) - un( &
              size(un, kind=i64) - 2_i64)) + nu * dt / dx ** 2_i64 * ( &
              un(1_i64) - 2_i64 * un(0_i64) + un(size(un, kind=i64) - &
              2_i64))
...
end module mod_towx175kc7q6_towx175kc7q6
